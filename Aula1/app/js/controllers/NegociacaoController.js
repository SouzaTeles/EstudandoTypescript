System.register(["../views/NegociacaoView", "../views/MensagemView", "../models/Negociacoes", "../models/Negociacao"], function (exports_1, context_1) {
    "use strict";
    var NegociacaoView_1, MensagemView_1, Negociacoes_1, Negociacao_1, NegociacaoController;
        ...
        execute: function () {
            NegociacaoController = class NegociacaoController {
                constructor() {
                    ...
                    this._negociacoesView = new NegociacaoView_1.NegociacaoView('#negociacoesView');
